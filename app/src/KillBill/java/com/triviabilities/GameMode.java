...
public class GameMode
{
    ...
    private GameMode(Difficulty difficulty, GamePlayType gamePlayType)
    {
        ...
        if (difficulty == Difficulty.EASY && gamePlayType == GamePlayType.CHALLENGE)
        {
            ...
            this.numQuestionsAvailable = 357;
            this.numQuotesAvailable = 302;
            this.questionXmlFileName = "Questions-Android-KillBill.xml";
            this.quoteXmlFileName = "Quotes-Android-KillBill.xml";
            this.gameModeTitle = "Challenge";
            this.getHighScoreURL = debugMode ? "http://triviabilities.com/Test/ShortChallenge.php" : "http://triviabilities.com/KillBill/ShortChallenge.php";
            this.putHighScoreURL = debugMode ? "http://triviabilities.com/Test/put_score.php?table=ShortChallenge&secret=dbsecret&name={{NAME}}&score={{SCORE}}" : "http://triviabilities.com/KillBill/put_score.php?table=ShortChallenge&secret=dbsecret&name={{NAME}}&score={{SCORE}}";
        }
        else if (difficulty == Difficulty.EASY && gamePlayType == GamePlayType.SPEED)
        {
            ...
            this.getHighScoreURL = debugMode ? "http://triviabilities.com/Test/ShortSpeed.php" : "http://triviabilities.com/KillBill/ShortSpeed.php";
            this.putHighScoreURL = debugMode ? "http://triviabilities.com/Test/put_score.php?table=ShortSpeed&secret=dbsecret&name={{NAME}}&score={{SCORE}}" : "http://triviabilities.com/KillBill/put_score.php?table=ShortSpeed&secret=dbsecret&name={{NAME}}&score={{SCORE}}";
        }
    }
