...
public class GameMode
{
    ...
    private GameMode(Difficulty difficulty, GamePlayType gamePlayType)
    {
        ...
        if (difficulty == Difficulty.EASY && gamePlayType == GamePlayType.CHALLENGE)
        {
            ...
            this.numQuestionsAvailable = 210;
            this.numQuotesAvailable = 724;
            this.questionXmlFileName = "Questions-Android-JustinBieber.xml";
            this.quoteXmlFileName = "Quotes-Android-JustinBieber.xml";
            this.gameModeTitle = "Challenge";
            this.getHighScoreURL = debugMode ? "http://triviabilities.com/Test/ShortChallenge.php" : "http://triviabilities.com/JustinBieber/ShortChallenge.php";
            this.putHighScoreURL = debugMode ? "http://triviabilities.com/Test/put_score.php?table=ShortChallenge&secret=dbsecret&name={{NAME}}&score={{SCORE}}" : "http://triviabilities.com/JustinBieber/put_score.php?table=ShortChallenge&secret=dbsecret&name={{NAME}}&score={{SCORE}}";
        }
        else if (difficulty == Difficulty.EASY && gamePlayType == GamePlayType.SPEED)
        {
            ...
            this.getHighScoreURL = debugMode ? "http://triviabilities.com/Test/ShortSpeed.php" : "http://triviabilities.com/JustinBieber/ShortSpeed.php";
            this.putHighScoreURL = debugMode ? "http://triviabilities.com/Test/put_score.php?table=ShortSpeed&secret=dbsecret&name={{NAME}}&score={{SCORE}}" : "http://triviabilities.com/JustinBieber/put_score.php?table=ShortSpeed&secret=dbsecret&name={{NAME}}&score={{SCORE}}";
        }
    }
